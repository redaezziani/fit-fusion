...
>(({
  ...
  const variantIcons = {
    success: (
      <div className="size-8 border-green-500/55 border rounded-full flex justify-center items-center relative before:size-12 before:border before:border-green-500/30 before:rounded-full before:absolute">
      <svg
